...
void loop() {
  ...
  if (fft.available()) {
    ...
    for (x=0; x < NEO_PIXEL_COUNT; x++) {
      ...
      if (true) {
          pixels.setPixelColor(4*x,pixels.Color(0,10,0));
          pixels.setPixelColor(4*x-1,pixels.Color(0,10,0));
          pixels.setPixelColor(4*x-2,pixels.Color(0,10,0));
          pixels.setPixelColor(4*x-3,pixels.Color(0,10,0));
          ...
          g = getRedValueFromColor(value);
          b = getRedValueFromColor(value);
          Serial.println(r);
          pixels.setPixelColor(4*x,value,r*0.8,g*0.8,b*0.8);
          pixels.setPixelColor(4*x-1,r*0.8,g*0.8,b*0.8);
          pixels.setPixelColor(4*x-2,r*0.8,g*0.8,b*0.8);
          pixels.setPixelColor(4*x-3,r*0.8,g*0.8,b*0.8);
